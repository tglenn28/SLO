...
function [Results, smootherResult] = AliConcurrent503aided2_latest(lag, sync, priorNoise, Noise, edges_non, edges_con, T_Pose_GT, non_con, Tr, printresult, loopclosures, color)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
plot3DTrajectory(filterResult, 'g');
