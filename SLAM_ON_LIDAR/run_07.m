...
%% load data 
datapath = '~/Desktop/Project/Final/iSAM_ICP_on_LIDAR/Tranformation_Data/transformations&GT07.mat';
%OR
%for removed labels/vehicles
% datapath = '~/Desktop/Project/Final/Final2/Tranformation_Data/transformations&GT07_labels_removed.mat';
% make sure transformations&GT.mat is in the current directory%    0.5331

[edges_gicp_con, edges_gicp_non, cov_gicp_con, cov_gicp_non, edges_sicp_con, edges_sicp_non, cov_sicp_con, cov_sicp_non, T_Pose_GT, edges_sic, edges_gicp] = AliloadTransformations03(datapath);
...
% closureidx = findloopclosure(gt3, 0.6, 1); %to generate loop closures
%OR
load("loopclosures_0.6_07.mat");
...
% edges_sicp_con = vertcat(edges_sicp_con, edges_sicp_con(edges_sicp_con(:,size(edges_sicp_con,2))==2,:));
...
lidar_poses_sicp = loopThroughPosesISAM2(ax,'g','SICP - iSAM2',T_Pose_GT, edges_sicp_con(:,1:end-1),noiseMod, Tr, loopclosures);
lidar_poses_gicp = loopThroughPosesISAM2(ax,'r','GICP - iSAM2',T_Pose_GT, edges_gicp_con(:,1:end-1),noiseMod, Tr, loopclosures);
