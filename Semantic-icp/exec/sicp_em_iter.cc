...
*/
    ...
    Eigen::Matrix4f gicpTransform;
    Eigen::Matrix4f prevConsecGicpTransfrom;
    int numDigitsSource;
    int numDigitsTarget;
	...
	for(size_t j = 1; j <= 3; j++) 
	{
		...
		*/
		...
		/////// These lines aren't in test_icp.cc /////////////////////////////
		...
		if (n == 0)
		    ...
		    gicp.align(final1, prevConsecGicpTransfrom.cast<float>());
		else
		    gicp.align(final1, gicpTransform.cast<float>());
